                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="buttons level mb-4">
                            <div class="flex">
                                <a href="/category/create" class="btn btn-success">Agregar Categoría</a>
                                <!-- Cambiado a btn-success -->
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"> <!-- Cambiado a text-center -->
                                                <a class="btn btn-secondary btn-sm mx-2"
                                                    href="/category/{{ $category->id }}/edit">Editar</a>
                                                <!-- Cambiado a btn-secondary -->
                                                <form method="POST" action="{{ url('category/' . $category->id) }}"
                                                    data-confirm="¿Estás Seguro?" class="d-inline">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                                                    <button type="submit" class="btn btn-danger btn-sm">Eliminar</button>
                                                    <!-- Botón eliminar ya en btn-danger -->
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
