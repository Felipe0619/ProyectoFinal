<div class="form-row">
    <div class="form-group mb-4">
        ...
        <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name"
            name="name" placeholder="" value="{{ isset($category) ? $category->name : old('name') }}">
        @if ($errors->has('name'))
    ...
    <div class="form-group mb-4">
        ...
        <textarea class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" id="description"
            name="description" placeholder="Descripción de la categoría">{{ isset($category) ? $category->description : old('description') }}</textarea>
